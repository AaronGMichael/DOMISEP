                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <a href="../assets/guide/usermanual.pdf" target="_blank" rel="noreferrer noopener" download><button type="submit" name="downloadManual" class="button-submit-profile" onclick="return download()"><i class="fa-solid fa-download"> </i> User Manual</button></a>
