                        ...
                        <div class="col-9 col-sm-7 col-md-6 m-auto">
                            <div class="card border-0 shadow">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-upc-scan" viewBox="0 0 16 16" style = "margin-left: 45%;">
                                    ...
                                    <form method="POST" action="../utils/addSensor.php">
                                        <fieldset>
                                            <div class="form-group" style = "margin-bottom: 10px;">
                                                ...
                                                <select class = "form-control" placeholder="Sensortype" type = "name" name = "sensortype" required>
                                                    ...
                                                    <?php foreach($sensorTypeList as $sensorType){ ?>
                                                        <option value="<?php echo $sensorType["id"] ?>"><?php echo $sensorType["name"]?> / <?php echo $sensorType["unit"]?></option>
                                                    <?php }?>
                                                </select>
                                            </div>
                                            <div class="form-group" style = "margin-bottom: 10px;">
                                            ...
                                            <div class="form-group" style = "margin-bottom: 10px;">
                                                ...
                                                <input class="form-control" placeholder="Enter Minvalue" type="number" step="0.1" name="minvalue" required>
                                            </div>
                                            <div class="form-group" style = "margin-bottom: 10px;">
                                                <label for="maxvalue">Maximal Value:</label>
                                                <input class="form-control" placeholder="Enter Maxvalue" type="number" step="0.1" name="maxvalue" required>
                                            </div>
